        ...
        <main className="p-6">
          ...
          Penthouse allows you to co-invest into high-yield rental properties
              ...
              <ul className="space-y-5">
                <h1 className="dark:text-gray-200 text-base text-gray-500 text-xl">Benefits</h1>
                <li className="dark:text-gray-200 text-base text-gray-500">1. Lower entry cost (as low as 100 BUSD)</li>
                <li className="dark:text-gray-200 text-base text-gray-500">2. 100% hassle free</li>
                <li className="dark:text-gray-200 text-base text-gray-500">3. Passive income and equity appreciation</li>
