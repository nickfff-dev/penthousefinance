...
const stickyOnScroll = () => { 
  ...
  return (
    <nav className="bg-primary dark:bg-black dark:text-secondary  border-b border-black dark:border-secondary" id="navbar">

      <div className="md:mx-5 flex items-center justify-between p-4 ">
        <div className="flex md:order-3 order-2 justify-between">
          <button type="button" className="text-black hover:text-primary  shadow uppercase md:text-lg bg-secondary hover:bg-black focus:ring-4 md:mr-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-6 py-1.5 text-center  md:mr-0 dark:bg-secondary  ">Join Us</button>
       ...
       <img src="https://penthouse.finance/wp-content/uploads/2022/05/Penthouse_banner1-300x48.png" className="h-6 mr-3 sm:h-12 dark:bg-secondary dark:p-1" alt="Flowbite Logo" />
        ...
        <div className={`${show ? "block" : "hidden"} items-center justify-between  w-full md:flex md:w-auto md:block md:order-1`} id="cta">
          <ul className="flex flex-col p-4 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8  md:mt-0 md:text-sm md:font-medium md:border-0   ">
            <li>
              <a href="/" className="block  text-lg uppercase  text-gray-700  rounded md:bg-transparent  md:p-0 dark:text-secondary" aria-current="page">How It Works</a>
            </li>
            <li>
              <a href="/" className="block  text-lg   uppercase text-gray-700 rounded    md:p-0  dark:text-secondary dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">About Us</a>
            </li>
