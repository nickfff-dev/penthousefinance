...
const WhatYouGet = () => { 
  return (
  <div className="m-5 rounded-3xl p-6 grid relative   grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 bg-primary dark:bg-black    dark:border-gray-200 border-black">
     <div className="ml-12 pt-5 pb-5 "  >
      ...
      <div className="p-4 space-x-4 space-y-4">
        <h1 className=" lg:text-4xl text-center w-full mb-8 dark:text-yellow-300">WITH PENTHOUSE, YOU GET:</h1>
