const Modal = (props: any) => { 
  ...
  return (
    <div className="modal shadow-black shadow-xl hidden fade fixed top-0 left-0 right-0 z-20 mx-auto w-[1000px]  w-1/2 h-full outline-none overflow-x-hidden overflow-y-auto"
