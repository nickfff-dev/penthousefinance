...
const AfterHero = () => { 
  return (
    <div className="m-5  py-4  rounded-3xl dark:bg-bdark bg-primary">
      <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-5  items-start mb-3 ">
