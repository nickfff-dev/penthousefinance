...
const AfterHero = () => { 
  return (
    <div className="m-5 p-10 flex flex-col justify-center items-center font-poppins rounded-3xl dark:bg-bdark bg-[#faf7f4]">
      ...
      <p className="px-8 lg:text-[21px] leading-loose tracking-tight text-gray-700 dark:text-gray-300 text-sm lg:text-left mobile:text-center">Penthouse is for people who want to invest in vacation rental properties – but don’t want to buy a whole home, don’t have the financial capability to buy an entire property, and/or don’t want to deal with the headaches that go along with it.</p>
     ...
     <a href="/" className=" px-8 py-3  uppercase dark:text-black text-base leading-6 font-medium text-white rounded-full text-white bg-secondary dark:bg-yellow-200 dark:hover:bg-secondary hover:text-black focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo transition duration-150 ease-in-out md:py-3 md:text-lg md:px-10">
              Get Started
              </a>
    </div>
  )
