...
const AfterHero = () => { 
  ...
  return (
    ...
    <div className="m-5 p-10 flex flex-col justify-center items-center font-poppins rounded-3xl dark:bg-bdark bg-[#faf7f4]">
     ...
     <button onClick={()=>setMymodal(true) }  className=" px-8 py-3  uppercase dark:text-newblack text-base leading-6 font-medium text-newblack rounded-full text-white bg-secondary dark:bg-yellow-200 dark:hover:bg-secondary hover:text-newblack focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo transition duration-150 ease-in-out md:py-3 md:text-lg md:px-10">
              Get Started
              </button>
      </div>
      {
