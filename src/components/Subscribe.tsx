  ...
  return (
    <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1  gap-5 items-center  p-20 m-5 dark:bg-black rounded-3xl bg-primary">
      ...
      <div className="flex flex-col justify-start items-start gap-8 ">
        ...
        <input type="text" className="border-b w-full bg-transparent dark:text-gray-300 rounded-lg p-3" placeholder="Enter Your Email " />
        <p className="dark:text-gray-300">I give Penthouse permission to contact me & I agree to the terms. This site is protected by reCAPTCHA and the Google privacy policy, terms of service and mobile terms.</p>
